      ...
      <article className='flex flex-col p-8 gap-6 text-darkblue sm:grid sm:grid-areas-[recipe_recipe,lorem_lorem,image_nutrients,ingredients_labels] sm:grid-cols-2 lg:grid-areas-[recipe_recipe,lorem_image,ingredients_nutrients,labels_.] max-w-2xl lg:max-w-7xl'>
        ...
        <section className='font-normal text-black sm:grid-in-[lorem]'>
          <p>
            ...
            Suspendisse suscipit arcu quis libero rutrum posuere. Aliquam facilisis dapibus nunc,
            nec aliquet sapien congue at. Morbi tempus massa purus, et ultricies eros egestas at.
          ...
          <p className='hidden sm:block sm:mt-4'>
            ...
            turpis erat, sed elementum diam sodales vitae. Nullam semper quis nulla eget
            ullamcorper. Quisque pretium aliquet nunc at interdum. Pellentesque accumsan magna
            dignissim, sodales nibh at, condimentum mauris. Donec ac semper urna. Nam ut neque.
          </p>
        </section>
