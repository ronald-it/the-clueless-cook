  ...
  return (
    <footer id='footer' className='bg-darkblue py-6 lg:py-14 flex justify-center'>
      <div className='flex flex-col px-8 gap-y-8 sm:flex-row sm:justify-between sm:[&>*]:justify-start sm:w-full sm:max-w-2xl lg:max-w-7xl'>
        <div className='flex flex-col items-center sm:items-start gap-y-2 [&>*:first-child]:mb-2 [&>*:first-child]:text-lightblue [&>*:first-child]:font-semibold sm:[&>*:first-child]:text-lg sm:[&>*]:text-xs lg:[&>*:first-child]:text-2xl lg:[&>*]:text-base [&>*]:text-white [&>*]:font-light'>
          <h3>Information</h3>
        ...
        <div className='flex flex-col items-center sm:items-start gap-y-2 [&>*:first-child]:mb-2 sm:[&>*:first-child]:text-lg lg:[&>*:first-child]:text-2xl'>
